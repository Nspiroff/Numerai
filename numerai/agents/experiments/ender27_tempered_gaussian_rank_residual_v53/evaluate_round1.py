"""Stdlib-only launcher for the frozen Ender27 Round-1 evaluator."""
...
def _require_outer_launch() -> str:
    ...
    if (
        ...
        raise ValueError(
            "Ender27 evaluator launcher requires isolated Python -I -B -P "
            "and an exact nonempty -X pycache_prefix."
        )
    return option
